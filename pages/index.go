...
//	row4 := components.Row().SetContent(col5 + col6).GetContent()
	...
	row7 := components.Row().SetContent(`<p>Текстовое описание как работать с сайтом, оптимизировать и загружать контент.</p>`).GetContent()

	return types.Panel{
		Content:     row7,
		Title:       "Админ Панель",
		Description: "сайт проектмаркетинг +1 на Go",
	}, nil
}
